...
console.log(
  "-> Đang kiểm tra tính năng tự động ẩn công cụ player trên máy tính (Desktop Auto-hide)...",
);
...
assert(
  css.includes(".player-page-root .player.controls-hidden") && css.includes("cursor: none"),
...
console.log(
  "   ✓ PlayerControls tích hợp đầy đủ các sự kiện chuột và bảo lưu hiển thị khi đang tương tác.",
);
